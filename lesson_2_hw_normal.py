...
task_data = '02.11.2013'
data_list = task_data.split('.')
month = {
        '01': 'января',
        '02': 'февраля',
        '03': 'марта',
...
string_data = data_list[0] + ' ' + data_list[1] + ' ' + data_list[2] + ' ' "года"
print(string_data)
...
n = int(input("Введите число для отображения количества случайных чисел: "))
new_list = []
...
# a)
task_list = [1, 2, 4, 5, 6, 2, 5, 2]
new_list = set(task_list)
